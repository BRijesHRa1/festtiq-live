...
//       {/* Slide-in panel */}
//       <div
//         className={`absolute right-0 top-0 h-full w-[800px] bg-white shadow-lg z-50 transform transition-transform duration-500 rounded-l-3xl ${
...
//   <h2
//     className="text-3xl font-medium leading-[117%] tracking-[-1.5px] text-[#181375] font-['Plus Jakarta Sans'] text-left"
