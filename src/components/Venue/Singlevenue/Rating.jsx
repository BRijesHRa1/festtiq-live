...
// const Rating = () => {
//   return (
//     <div className="w-[1440px]  mx-auto px-10 font-['Plus_Jakarta_Sans']">
//         {/* Horizontal Divider at Bottom */}
// <hr className="w-full border-t border-gray-200 mt-3 mb-10" />

//       {/* Title Row */}
//       <div className="w-full h-[58px]     flex flex-col justify-center">
//         <h2 className="text-[#181375] text-3xl  font-semibold ">Ratings</h2>
//         <p className="text-[14px] text-[#828282] py-2">
//           <span className="text-yellow-500 ">★</span> 4.5 · 103 Reviews
//         </p>
//       </div>

//       {/* Reviews Grid */}
//       <div className="w-full h-[718px] py-10  flex flex-wrap gap-[20px]">
//         {reviews.map((review, i) => (
//           <div
//             key={i}
//             className="w-[614px] h-[327px] border border-[#E0E0E0] rounded-[8px] p-[40px] flex flex-col gap-[20px]"
//           >
//             {/* Profile */}
...
//                   {review.name}
//                 </p>
//                 <p className="text-[12px] text-[#828282]">{review.location}</p>
//               </div>
//             </div>
...
//               ))}
//               <span className="text-[12px] text-[#828282] ml-2">{review.date}</span>
//             </div>
