...
//   return (
//     <div className="fixed inset-0 z-50 flex justify-center items-center rounded-4xl  bg-[rgba(0,0,0,0.5)]">
//       <div className="bg-white w-[700px] h-[605px] p-[60px_30px] rounded-3xl  relative">
//         {/* Close Button */}
//         <button
//           onClick={onClose}
...
//         {/* Modal Title */}
//         <h2 className="text-center font-[Plus_Jakarta_Sans]  text-[24px] leading-[133%] text-[#000] mb-8">
//           Select Your Event Type
//         </h2>

//         {/* Mapped Sections */}
//         <div className="mx-auto w-[500px] h-[329px] rounded-[12px] px-[10px] space-y-6 overflow-y-scroll hide-scrollbar">
//           {eventGroups.map((group) => (
//             <div key={group.title}>
//               <h3 className="font-bold text-lg text-[#181375] mb-2">
//                 {group.title}
//               </h3>
...
//                           : "border-purple-600"
//                       } relative before:content-[''] before:absolute before:top-1/2 before:left-1/2 before:-translate-x-1/2 before:-translate-y-1/2 before:w-2 before:h-2 before:rounded-full ${
//                         isSelected(option)
...
//             Clear Selection
//           </button>
//           <button className="px-6 py-2 bg-gradient-to-r from-purple-600 to-purple-700 text-white rounded-md shadow-md hover:brightness-110 transition">
//             Show Results
//           </button>
//         </div>
//       </div>
